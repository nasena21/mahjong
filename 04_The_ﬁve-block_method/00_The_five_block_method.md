...
eﬃciency principles — e.g., superiority of side-wait protoruns, the
value of having two pairs in a hand rather than three, and the value
of stretched single or bulging ﬂoat shapes, to name a few.
...
time,1 and tile eﬃciency is not the only factor we need to consider in
making a discard choice. Moreover, some of the tile eﬃciency prin-
...
at times wonder whether to retain a bulging ﬂoat shape or to retain
two pairs in a hand, when we have to discard one of the two.

The ﬁve-block method I introduce in this chapter will help us
prioritize between competing principles and ﬁnd the most eﬃcient
discard choice quickly.2 The core idea of the ﬁve-block method is
deceptively simple; we ﬁrst identify ﬁve tile blocks in a hand — four
...
made within 5 seconds. In oﬄine games, we should make choices even faster
