---
title: Finding A Redundant Tile
order: 1
---

# Finding a redundant tile

We all understand that a standard hand must have ﬁve blocks of
tiles — four groups and one head — to win. The ﬁve-block method
encourages us to be always conscious about ﬁve tile blocks in a hand.
...
Looking at each of the ﬁve blocks, the pair of , the protorun
ﬀ, and the set of % are all self-suﬃcient; we keep them as they
are. Our discard choice should thus be from the third or the fourth
blocks,  or . Let’s now compare these two closedwait
blocks. While  is being useful within the block it belongs to,
enabling the hand to accept , is completely redundant; the hand
can accept 
 without having . Therefore, the ideal discard here is
.
...
with the other blocks. Likewise, if we discard , this block
...
ﬀ is not an option. Notice that the block in souzu (bamboos) has
...
. Then, none of the ﬁve blocks is too weak, and each block has at
most three tiles.
...
applied the ﬁve-block method in your mind. The goal of this chapter
is to train our mind further, so that it becomes our second nature to
identify ﬁve tile blocks in a hand.
