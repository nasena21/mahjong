...
and martial arts. The kyu (級) ranks
are shown in arabic numbers, go-
ing from 9 級to 1 級in descending
order. After passing 1級, you enter
...
at the time of writing this book. Table 2.1 shows the distribution of
...
you move further up. For example, to proceed from 六段(sixth dan) to 七段 (seventh dan), you need to earn as many as 1200 points.
To ﬁnd out how many more points you need to earn to advance
...
example, the default points for 六 段 players are 1200 points. When
...
般, 上 級, 特 上, or 鳳 凰), and your current rank.
1
You gain positive
...
each time your rank rises above 3 級, the points you lose get bigger
by 15 points. That is, 2 級 players lose 15 points if they come in
fourth place; 1 級 players lose 15

2 = 30 points; 初 段 players lose
15

...
be players’ top priority in Tenhou games. This is in contrast to standard
mahjong games, where the reward for coming in ﬁrst usually
outweighs the cost of coming in fourth, thanks to the oka system.
2

To easily ﬁnd out how many
points you earn / lose for each place
in a given type of game for your rank,
mouseover the 予約 button in each
...
contents of this book, you can perhaps reach as high as 四 段 (fourth
dan) if you play a few hundred games or so. However, moving further
...
change in R after a game, ∆R, is calculated with the following formula:
∆R = (P +

R)

...
higher R than you) while it is negative when you play against players
who are “weaker” than you. Therefore, when you win against
...
your punishment will be severer than when losing against stronger players. Because of these features, one might say that your R better
reﬂects your skill levels than your kyu / dan rank.
...
there is no oka in EMA games, the reward for coming in ﬁrst is much smaller
