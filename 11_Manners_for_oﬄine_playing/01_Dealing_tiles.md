...
manners for four diﬀerent phases of a game — (1) dealing tiles, (2)
drawing and discarding, (3) calling, and (4) winning a hand. Each
entry is given a rank, from one star (∗) to three stars (∗∗∗). Three-star
manners are more important; you should try to acquire three-star
manners ﬁrst, and then move on to practice two-star and one-star
ones.
A.1
Dealing tiles
1-1: Shuﬄing ∗∗
I recommend a 2-step shuﬄing approach. First, shuﬄe tiles re-
ally hard. Don’t worry about keeping the tiles face down at this point.
...
shuﬄe them face down gently. This will guarantee that no one re-
...
ﬁve tiles in the middle, and another six tiles on the right, illustrated
as follows.
ﬃﬃﬃﬃﬃﬃ
ﬃﬃﬃﬃﬃ
ﬃﬃﬃﬃﬃﬃ
This will make it signiﬁcantly easier for the dealer to identify the
...
k tiles counterclockwise rather than counting k tiles
...
After breaking the wall, the rinshan tile (the ﬁrst replacement
...
1-7: Turn over the dora indicator 
Immediately after putting down the rinshan tile, the dora indica-
tor should be turned over. Doing so is way more important than, say,
separating the dead wall from the end of the wall (which is completely
unnecessary especially at the beginning of a hand). In my
experience, European players somehow like to do the latter ﬁrst and
don’t open the dora indicator even after they ﬁnish the dealing.
1-8: Look at the tiles 
As you take tiles from the wall during the initial dealing, you
should start taking a look at them. Don’t wait until you get all thirteen
tiles; doing so is a waste of time not only for you but also for the
other players.
1-9: Dealer’s ﬁrst discard 
...
time to decide whether to call pon / chii / ron on the ﬁrst discard.