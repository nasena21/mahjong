...
declare it. When declaring tsumo scores, say the payment by a nondealer
...
Having 500-point sticks would make stick payment much more eﬃcient.
To streamline the payment, you should try to minimize the num-
ber of sticks exchanged on the table. Here are two examples of eﬃcient
method of payment.
3900 ron
When a player wins a 3900 hand, the player who discarded the
winning tile gives the winner one
, and the winner
gives back 1100 points with one
and one
.
5200 tsumo
When a player gets a 1300-2600 tsumo, the most eﬃcient and beautiful
method of payment is as follows.
1. The ﬁrst non-dealer (the one sitting closer to the winner) pays
the exact amount with one
and three
.
...
two of the three
he got from the ﬁrst, which en-
sures that the second non-dealer pays 1300.
4. The dealer gives the winner 5100 with one
and
one
.

5. The winner gives back the dealer 2500 with the two
he got from the two non-dealers and the one
he
...
having 2900 more points than the second ranked player. Suppose
...
yaku is either unnecessary or even undesirable. I personally think it’s unnecessary,
especially when playing with experienced players. However, given that
...
(Tenhou ID: 零面聴). I thank him for letting me use it in this book.

5
Continuing the game means he runs the risk of losing the placement bonus
