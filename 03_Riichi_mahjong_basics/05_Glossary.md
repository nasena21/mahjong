...
Run (chow / sequence; shuntsu) is a set of three consecutive number
tiles.
Set (pung / triplet; kotsu) is a set of three identical tiles.
Quad (kong; kantsu) is a set of four identical tiles.
Protorun (taatsu) is a set of two tiles in the same suit that can become
a run when one more tile is added.
...
tiles.
Bulging ﬂoat (nakabukure) shape is a four-tile shape that is made
up with a run and one ﬂoating tile in the middle of the run.
Skipping shape is a four-tile shape made up with a run and one
ﬂoating tile located at two tiles away from the run.