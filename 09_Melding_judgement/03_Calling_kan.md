...
There are three ways to call kan — making a concealed quad
(ankan), making an open quad (daiminkan), and extending an open
set to an open quad (kakan). I will discuss decision criteria for each
of the three cases in turn.

##  Concealed quad (ankan)
The beneﬁts of making a concealed quad includes:
...
2000 points to win the game, then you should kan immediately. As
...
- the hand is ready with a good wait, and the hand value is between
2000 and 5200 points;
...
## From an open set to an open quad (kakan)
When you draw the fourth tile of an open set, you have an opportunity
to extend the open set to an open quad. Conditions to justify
...
the risk of giving your opponents a chance to get chankan (Robbing
the Kong).

You can extend an open set to an open quad in any of the follow-
ing situations:
