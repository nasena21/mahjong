...
speciﬁcally, when you call chii with an edge-wait or closed-wait protorun
...
do not want to make your mangan hand into a 1000 hand, but the hand
...
ready, as long as doing so improves the wait and/or the scores.
...
so that we can have a good-wait block as the ﬁnal wait of the hand.
...
for riichi bets + 300 for continuation. This is not much diﬀerent
