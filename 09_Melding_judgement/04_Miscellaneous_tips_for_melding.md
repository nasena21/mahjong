---
title: Miscellaneous Tips For Melding
order: 4
---
...
chii before you do.5 This means that you need to think ahead and
...
- suji, whereas  can be captured only by - suji. Moreover,
even if you deal into an opponent’s - wait, the hand value
...
the two instances. In this sense, your act of calling pon/kan beneﬁts
...
are deciding which one of the three valueless wind tiles  !" to discard in the 1st turn. In this case, you should discard  ﬁrst. If the
South player calls pon on  you discard, that would be much better
than if he called pon from the North player. Moreover, if you discard
